...
<head>
    ...
    <title>Project Progress Updated</title>
...
<body>
    <div class="card">
        ...
        <h1>Project Progress Updated for Project {{ $project->id }}</h1>

        <p>Hello {{ $project->booking->user->name }},</p>

        <p>The progress for your project has been updated:</p>
        
        <h3>Progress Details:</h3>
        <ul>
            <li><span>Phase:</span><span>{{ ucfirst($phase) }}</span></li>
            <li><span>Progress:</span><span>{{ $phaseProgress }}%</span></li>
