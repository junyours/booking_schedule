...
<body>
    <div class="card">
        ...
        <p>We are pleased to let you know that your booking is confirmed. Here are the details:</p>
        ...
        <ul>
            ...
            <li><span><strong>Booking Status:</strong></span><span class="status status-{{ strtolower($booking->booking_status) }}">{{ ucfirst($booking->booking_status) }}</span></li>
