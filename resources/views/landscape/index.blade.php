                            ...
                            @foreach ($services as $service)
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        @if ($service->design)
                                            <img src="{{ asset('storage/' . $service->design) }}"
                                                alt="{{ $service->name }}"
                                    ...
                                    <td>
                                        <div
                                            ...
                                            <a href="{{ route('landscape-services.edit', $service->id) }}"
                                                class="btn btn-sm"
                                            ...
                                            <button class="btn btn-sm"
                                                ...
                                                data-toggle="modal" data-target="#archiveConfirmModal" data-toggle="tooltip"
                                                title="Archive Service" data-id="{{ $service->id }}"
...
@section('scripts')
    <script>
        $('#archiveConfirmModal').on('show.bs.modal', function(event) {
            ...
            modal.find('#archiveForm').attr('action', '{{ route('landscape-services.archive', ':id') }}'.replace(
                ':id', serviceId));
        });
