    ...
    <div class="container mt-5">
        <div class="card shadow-lg">
            <div class="card-header"
                style="background-image: url('{{ asset('landscaping.jpg') }}'); height: 180px; background-size: cover; background-position: center;">
                <h6 class="mb-0"></h6>
            </div>
            ...
            <div class="card-body p-4">
                ...
                <form id="landscapeServiceForm"
                    action="{{ isset($service) ? route('landscape-services.update', $service->id) : route('landscape-services.store') }}"
                    ...
                    <div class="d-flex justify-content-between">
                        <button type="submit" id="submitBtn" class="btn btn-outline-info rounded-pill px-4 py-2">
                            <i class="fas fa-save me-1"></i> <!-- Icon for 'Save/Update' -->
                            {{ isset($service) ? 'Update Service' : 'Add Service' }}
                        </button>
                        <a href="{{ route('landscape') }}" class="btn btn-outline-secondary rounded-pill px-4 py-2">
